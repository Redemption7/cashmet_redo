...
class BankToWallet extends StatefulWidget {
  const BankToWallet({super.key});

  @override
  State<BankToWallet> createState() => _BankToWalletState();
}

class _BankToWalletState extends State<BankToWallet> {
